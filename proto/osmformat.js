'use strict'; // code generated by pbf v3.0.2
...
Relation._readField = function (tag, obj, pbf) {
    ...
    else if (tag === 10) pbf.readPackedVarint(obj.types); //obj.types.push(pbf.readVarint());
};
Relation.write = function (obj, pbf) {
    ...
    if (obj.types) for (var i = 0; i < obj.types.length; i++) pbf.writeVarintField(10, obj.types[i]);
};
